...
public abstract class am extends ReplacementSpan {
	...
	private void d() {
		if (TextUtils.isEmpty(b))
			b = "";
		if (b.length() > 7)
			b = (new StringBuilder()).append(b.substring(0, 6)).append("...").toString();
		// a a1 = com.sina.weibo.k.a.a(g);
		Resources resources = g.getResources();
		m = resources.getDimensionPixelSize(R.dimen.timeline_small_card_icon_margin_left);
		i = resources.getDimensionPixelSize(R.dimen.timeline_small_card_icon_width);
		j = resources.getDimensionPixelSize(R.dimen.timeline_small_card_icon_height);
		int i1 = resources.getDimensionPixelSize(R.dimen.timeline_small_card_triangle_margin_right);
		int j1 = resources.getDimensionPixelSize(R.dimen.timeline_small_card_triangle_margin_left);
		n = resources.getDimensionPixelSize(R.dimen.timeline_small_card_title_margin_left);
		int k1 = resources.getDimensionPixelSize(R.dimen.timeline_small_card_title_text_size);
		...
		int i2 = resources.getDimensionPixelSize(R.dimen.timeline_small_card_min_width);
		...
		l[1] = drawable1;
		if (h == null) {
			h = resources.getDrawable(R.drawable.timeline_card_small_placeholder);
	...
	protected int b() {
		return g.getResources().getDimensionPixelSize(R.dimen.timeline_small_card_padding_right);
	}
	...
	public void draw(Canvas canvas, CharSequence charsequence, int i1, int j1, float f1, int k1, int l1, int i2, Paint paint) {
		canvas.save();
		int j2 = k1 + (i2 - k1 - f) / 2;
		c = (int) f1 + a();
	...
	public int getSize(Paint paint, CharSequence charsequence, int i1, int j1, Paint.FontMetricsInt fontmetricsint) {
