...
//	private static final String TAG = "TabWidget";
	...
	private int[] mDrawableIds = new int[] { R.drawable.tab_index01_selector,
			R.drawable.tab_index02_selector , R.drawable.tab_index03_selector,
			R.drawable.tab_index04_selector,R.drawable.tab_index05_selector};
...
//				e.printStackTrace();
//			} finally {
//				LogUtils.i(TAG, TabWidget.class.getSimpleName() + " 出错");
//			}
			a.recycle();
			return;
		}
...
//		this.setBackgroundResource(R.color.tab_dibu_bg_color);
...
//				itemName.setTextColor(Color.rgb(15, 196, 217));
				itemName.setTextColor(getResources().getColor(R.color.text_color));
				//	view.setBackgroundColor(Color.rgb(240, 241, 242));
			} else {
				itemName.setChecked(false);
				itemName.setTextColor(Color.rgb(107, 107, 107));
				itemName.setTextColor(getResources().getColor(R.color.shouyetabwedght_check));
...
//                checkedTextView.setTextColor(Color.rgb(15, 196, 217));
...
//				checkedTextView.setTextColor(Color.rgb(107, 107, 107));
				checkedTextView.setTextColor(getResources().getColor(R.color.shouyetabwedght_check));
