...
public class ImageLoaderConfig {
	...
	public static DisplayImageOptions initDisplayOptions(boolean isShowDefault) {
		...
		if (isShowDefault) {
			// 默认显示的图片
			displayImageOptionsBuilder.showStubImage(R.drawable.shape_imageload_bg);
			// 地址为空的默认显示图片
			displayImageOptionsBuilder
					.showImageForEmptyUri(R.drawable.shape_imageload_bg);
			// 加载失败的显示图片
			displayImageOptionsBuilder.showImageOnFail(R.drawable.shape_imageload_bg);
		}
		// 开启内存缓存
	...
	public static DisplayImageOptions initDisplayOptions(int targetWidth,
		...
		if (isShowDefault) {
			...
			// 加载失败的显示图片
			displayImageOptionsBuilder
					.showImageOnFail(R.drawable.shape_imageload_bg);
		}
		// 开启内存缓存
		displayImageOptionsBuilder.cacheInMemory(true);
		// 开启SDCard缓存
